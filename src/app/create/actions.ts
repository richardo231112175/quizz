            ...
            data: {
                ...
                questions: {
                    create: parsedQuestions.data.map((question, index) => ({
                        ...
                        single_choice_options: question.type === 'single_choice' ? JSON.stringify(question.singleChoiceOptions) : null,
                        single_choice_correct: question.type === 'single_choice' ? question.singleChoiceCorrect : null,
                        multiple_choice_options: question.type === 'multiple_choice' ? JSON.stringify(question.multipleChoiceOptions) : null,
                        multiple_choice_correct: question.type === 'multiple_choice' ? JSON.stringify(question.multipleChoiceCorrect) : null,
