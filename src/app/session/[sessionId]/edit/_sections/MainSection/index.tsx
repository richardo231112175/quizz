...
export default function MainSection({ quizId, counts,sessionData }: MainSectionProps): JSX.Element {
    const { form, setForm, quizSessionErrors, unknownError, isSubmitting, showSuccessDialog, handleSubmit }: useMainSectionType = useMainSection(quizId, counts, sessionData);
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="text-center mb-12 space-y-4">
                        ...
                        <div>
                            <h1 className="text-4xl font-bold tracking-tight mb-4">Edit Quiz Session</h1>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <Button type="submit" size="lg" disabled={isSubmitting}>Update Session</Button>
                        </div>
                    </form>
                </motion.div>
            </div>
