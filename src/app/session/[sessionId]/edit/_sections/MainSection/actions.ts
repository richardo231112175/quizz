...
export async function updateQuizSession(sessionId:number, quizId: number, form: QuizSessionType, counts: Counts): Promise<createQuizSessionReturn> {
    ...
    // const open_time : Date = new Date(form.openTime);
    // const enable : boolean = now-open_time.getMilliseconds() <0 ? true : false;
